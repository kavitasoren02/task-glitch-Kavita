...
export function computeROI(revenue: number, timeTaken: number): number | null {
  // Safely compute ROI = revenue / timeTaken
  // Return null when inputs are invalid or lead to non-finite results.
  ...
  // Keep results stable and UI-friendly: round to 2 decimal places
